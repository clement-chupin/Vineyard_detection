...
class ros_topic_manager:
	...
	def init_publisher(self,name):
		publisher = rospy.Publisher(name, PointCloud2,queue_size=1)
...
def get_line(a,b,marker_link="base_link"):
	...
	first_line_point.x = a[0]
	first_line_point.y = a[1]
	first_line_point.z = a[2]
	marker.points.append(first_line_point)
	# second point
	second_line_point = Point()
	second_line_point.x = b[0]
	second_line_point.y = b[1]
	second_line_point.z = b[2]
